...
const steps = [
    ...
    { icon: CircleIcon, label: 'Finalizig your website' },
...
const LoaderSteps = () => {
    ...
    bg-gray-950 relative overflow-hidden text-white">
            <div className="absolute insert-0 bg-linear-to-br from-blue-500/10
        via-purple-500/10 to-fuchsia-500/10 blur-3xl animate-pulse"></div>

            <div className="relative z-10 w-32 h-32 flex items-center justify-center">
                <div className="absolute insert-0 rounded-full border border-indigo-400
            animate-ping opacity-30" />
                <div className="absolute insert-0 rounded-full border border-b-purple-400/20" />
